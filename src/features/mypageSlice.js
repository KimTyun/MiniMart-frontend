   ...
   const dummyData = {
      orders: [
         ...
         },
         {
            ...
            status: 'DELIVERED',
            hasReview: true,
            seller: { id: 'seller_3', name: '베이킹 월드', avatarUrl: 'https://placehold.co/50x50/f5deb3/000000?text=Cake' },
            items: [{ itemId: 4, name: '베이킹 도구 세트', imageUrl: 'https://placehold.co/150x150/f0d85a/000000?text=Baking' }],
         },
      ],
      followings: [
